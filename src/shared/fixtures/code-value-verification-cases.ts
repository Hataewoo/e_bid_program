...
export const BUILTIN_CODE_VALUE_VERIFICATION_CASES: CodeValueVerificationCase[] = [
  ...
  {
    catalogId: 'TC-CV-002',
    name: 'TC-CV-002 Pattern 1 중복 on 051050',
    source: 'SRC-BUILTIN',
    masterNo: '00',
    masterValue: '051050',
    codes: [{ code: '99', type: '저점', description: '1 중복' }],
    expected: [{ code: '99', count: 2, matchKind: 'pattern' }],
  },
  {
    catalogId: 'TC-CV-003',
    name: 'TC-CV-003 Pattern 1 중복 on 00055',
    source: 'SRC-BUILTIN',
    masterNo: '07',
    masterValue: '00055',
    codes: [{ code: '98', type: '저점', description: '1 중복' }],
    expected: [{ code: '98', count: 0, matchKind: 'pattern' }],
  },
  {
    catalogId: 'TC-CV-004',
  ...
  {
    catalogId: 'TC-CV-010',
    name: 'TC-CV-010 Pattern 1 중복 high on 50505',
    source: 'SRC-BUILTIN',
    masterNo: '00',
    masterValue: '50505',
    codes: [{ code: '96', type: '고점', description: '1 중복' }],
    expected: [{ code: '96', count: 1, matchKind: 'pattern' }],
  },
  {
    catalogId: 'TC-CV-011',
